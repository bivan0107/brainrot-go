/* ==== Константы геймплея ==== */
const SPAWN_RADIUS_M   = 200;   // радиус спавна вокруг игрока
const DESPAWN_RADIUS_M = 300;   // удаляем далеко ушедших
const BUY_RADIUS_M     = 15;    // покупка только ≤ 15 м
const BASE_RADIUS_M    = 50;    // радиус базы
const MAX_ALIVE        = 10;    // максимум «диких» рядом
